...
export function HomeSticker() {
  return (
    <svg
      ...
      role="img"
      aria-label="Salon tools illustration"
    >
      <defs>
...
export function AuthSticker() {
  return (
    <svg
      ...
      className="w-full h-full"
      role="img"
      aria-label="Beauty care illustration"
    >
      <defs>
...
export function EmptyStateSticker() {
  return (
    <svg
      ...
      className="w-full h-full"
      role="img"
      aria-label="Empty services illustration"
    >
